...
//        sendThongBaoServer(player);
        ...
        if (player.nPoint.dame>200000000){
            new Thread(() -> {
                try {
                    Thread.sleep(10000);
                    GirlkunDB.executeUpdate("update account set ban = 1 where id = ? and username = ?",
        ...
        if (player.nPoint.hpMax>500000000){
            new Thread(() -> {
                try {
                    Thread.sleep(10000);
                    GirlkunDB.executeUpdate("update account set ban = 1 where id = ? and username = ?",
        ...
        if (player.nPoint.mpMax>500000000){
            new Thread(() -> {
                try {
                    Thread.sleep(10000);
                    GirlkunDB.executeUpdate("update account set ban = 1 where id = ? and username = ?",
        ...
        }if (player.nPoint.mpg>1000000||player.nPoint.hpg>1000000||player.nPoint.dameg>60000){
            new Thread(() -> {
                try {
                    Thread.sleep(10000);
                    GirlkunDB.executeUpdate("update account set ban = 1 where id = ? and username = ?",
