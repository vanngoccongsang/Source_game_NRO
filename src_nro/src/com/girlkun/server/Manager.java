...
//    public static byte RATE_EXP_SERVER = 1;// sau khi chinh
  ...
  public static final String queryTopNHS = "SELECT id, CAST( NguHanhSonPoint AS UNSIGNED) AS NguHanhSonPoint FROM player ORDER BY CAST( NguHanhSonPoint AS UNSIGNED) DESC LIMIT 50;";
...
//                    dataArray.clear();
    ...
    public void loadProperties() throws IOException {
        ...
        }else {GirlkunServer.gI().stopConnect();}
