...
//                            this.createOtherMenu(player, ConstNpc.BASE_MENU, "Chào con, con muốn ta giúp gì nào?", "Giải tán bang hội", "Nhận quà\nđền bù");
                            ...
                            this.createOtherMenu(player, ConstNpc.BASE_MENU, "Chào con, con muốn ta giúp gì nào?","Kho báu dưới biển", "Giải tán bang hội", "Lãnh địa Bang Hội", "Chuyển Sinh","Làm Súc Vật");
                        }
                    }
                }
            }
                ...
                if (canOpenNpc(player)) {
                    if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU,
                                ...
                                "Quên mật khẩu", "Nhận Ngọc", "Nhận Ngọc", "Nhận đệ tử", "Cách kiếm vàng", "Gíp Cốt");
                    }
                }
            }
            ...
            public void confirmMenu(Player player, int select) {
                if (canOpenNpc(player)) {
                    ...
                    if (this.mapId == 19) {
                        if (player.iDMark.isBaseMenu()) {
                            switch (select) {
                                case 0:if (player.getSession().player.nPoint.power >= 80000000000L && player.playerTask.taskMain.id > 21 ) {
                                    ChangeMapService.gI().changeMapBySpaceShip(player, 109, -1, 295);}
//                                    break;
                                    else {Service.gI().sendThongBaoOK(player, "Làm Nhiệm Vụ Và Đạt 80 Tỷ Sức Mạnh");}
                                break;
                                case 1:if (player.playerTask.taskMain.id >= 17 ) {
                                    ChangeMapService.gI().changeMapBySpaceShip(player, 68, -1, 90);}
                                else {Service.gI().sendThongBaoOK(player, "Làm Nhiệm Vụ Đi");}
                                    break;
                            }
                            ...
                            switch (select) {
                                case 0:
                                    ...
                                    break;
                                case 1:if (player.getSession().player.nPoint.power >= 80000000000L && player.playerTask.taskMain.id > 21 ) {
                                    ChangeMapService.gI().changeMapBySpaceShip(player, 109, -1, 295);}
//                                    break;
                                    else {Service.gI().sendThongBaoOK(player, "Làm Nhiệm Vụ Và Đạt 80 Tỷ Sức Mạnh");}
                                break;
                                case 2:if (player.playerTask.taskMain.id >= 17 ) {
                                    ChangeMapService.gI().changeMapBySpaceShip(player, 68, -1, 90);}
                                else {Service.gI().sendThongBaoOK(player, "Làm Nhiệm Vụ Đi");}
                                    break;
                            }
                        ...
                        if (player.iDMark.isBaseMenu()) {
                            switch (select) {
                                ...
                                case 6:
                                    ...
                                    break;
//                                case 7:
//                                    CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.NGUYET_AN);
//                                    break;    
//                                case 8:
//                                    CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.NHAT_AN);
//                                    break;    
                            }
...
//                                case CombineServiceNew.CHUYEN_HOA_TRANG_BI:
                                ...
                                case CombineServiceNew.NGUYET_AN:
                                    if (select == 0) {
                        ...
                        if (player.iDMark.isBaseMenu()) {
                            switch (select) {
                                case 0:
                                    ...
                                    else {Service.gI().sendThongBaoOK(player, "Yêu Cầu 80 Tỷ Sức Mạnh");}
                                    break;
                                case 1:
                                    if (player.nPoint.power >= 80000000000L){
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (this.mapId == 102) {
                        ...
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, "Kính chào Ngài Linh thú sư!", "Cửa hàng", "Đổi Hồn Linh Thú");
                    }
                }
            }
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    createOtherMenu(player, ConstNpc.BASE_MENU,
                            ...
                            "Tóp Sức Mạnh", "Top Nhiệm Vụ", "Top Nạp", "Top Săn Trộm", "Đóng");
                }
            }
